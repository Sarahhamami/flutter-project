...
class _WalkingPageState extends State<WalkingPage> with SingleTickerProviderStateMixin {
 ...
 @override
void didUpdateWidget(WalkingPage oldWidget) {
  ...
  void _updateStats() {
    setState(() {
      ...
      if (_routePoints.length > 1) {
        ...
        _distance = totalDistance / 1000; // Convert to km
        _calories = (_distance * 65).toInt(); // Rough estimate: 65 cal/km
      }
      _duration = Duration(seconds: _steps ~/ 2); // Rough estimate: 2 steps per second
    });
  }
                          ...
                          Marker(
                            ...
                            child: Container(
                              child: lottie.Lottie.asset(
                                'assets/lottie/walking_animation.json',
                                width: 50,
                                height: 50,
                                fit: BoxFit.cover,
                              ),
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildStatColumn(Icons.directions_walk, '$_steps', 'Steps'),
                          _buildStatColumn(Icons.timelapse, _formatDuration(_duration), 'Time'),
                          _buildStatColumn(Icons.directions_walk, '${_distance.toStringAsFixed(2)} km', 'Distance'),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            _buildSummaryRow('Total Steps', '$_steps'),
