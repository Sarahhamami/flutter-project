...
Future<void> _launchUrl(String url, {LaunchMode mode = LaunchMode.platformDefault}) async {
  try {
    ...
    if (await canLaunchUrl(uri)) {
      ...
      _showErrorSnackBar('Impossible d\'ouvrir ce lien');
    }
  } catch (e) {
    _showErrorSnackBar('Erreur lors de l\'ouverture du lien: $e');
  }
}
          ...
          child: Column(
            ...
            children: [
              ...
              ExpansionTile(
                ...
                children: [
                  _buildStep(1, "Ouvrir Google Cloud Console"),
                  _buildStep(2, "Cliquer sur 'Select Project' en haut"),
                  _buildStep(3, "Nommer le projet"),
                  _buildStep(4, "Attendre la création"),
                ],
              ),

              const SizedBox(height: 8),

              // Étape 5-7 : Google AI Studio
              ExpansionTile(
                title: Text(
                  "🔑 5-7. Créer la clé API Gemini",
                  style: TextStyle(
                    fontWeight: FontWeight.w600,
                ...
                children: [
                  _buildStep(5, "Aller sur Google AI Studio"),
                  _buildStep(6, "Créer une nouvelle clé API"),
                  _buildStep(7, "Copier la clé générée"),
                ],
              ),
            ],
          ),
